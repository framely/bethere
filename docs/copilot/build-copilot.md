...
projects and organizations, we introduce a frame called "[PageContext](https://buildmate.bethere.ai/org/ai.bethere/agent/copilot/struct/frame/64b8cd8d459bf49540e3dd9e)"
...
smaller ones together. Let's consider the [CloneProject](https://buildmate.bethere.ai/org/ai.bethere/agent/quickstarts/en/intent/64b897ae0f50353c647ca7e1)
...
Similarly, the [TestChatbot](https://buildmate.bethere.ai/org/ai.bethere/agent/quickstarts/en/intent/64b897ae0f50353c647ca7e2) skill can be created. Unlike the CloneProject skill,
...
For example, let's consider the [QuickStartClone](https://buildmate.bethere.ai/org/ai.bethere/agent/quickstarts/en/intent/64b897ae0f50353c647ca7e3) skill used to guide app users through the process of quickstart [cloning an echo chatbot](https://opencui.io/guide/clone-simple-chatbot.html). The happy path for the QuickStartClone skill involves the following steps:
