...
Log in to [OpenCUI](https://buildmate.bethere.ai/login). A personal organization will be created for you when you sign in.
...
This guide will show you how to clone a chatbot using `me.quickstart.pingpong` as an example. Click [here](https://buildmate.bethere.ai/org/me.quickstart/agent/pingpong/struct/type) to navigate to the chatbot：
