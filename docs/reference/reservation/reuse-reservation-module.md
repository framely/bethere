...
2. [Import](https://opencui.io/reference/platform/reusability.html#import-1) the [table reservation module](https://build.opencui.io/org/demo.opencui/agent/tableReservation/struct/type?page=0&list_type=all&search=&category=ALL) into your chatbot.
